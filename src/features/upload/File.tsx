        ...
        <div className="flex gap-2">
          <div className="input">
            <>
              <label
                htmlFor="file"
                className="flex size-40 w-full cursor-pointer items-center justify-center rounded-lg border-dashed bg-gray-100 p-2 text-center text-sm dark:bg-gray-900"
              >
                {files.length > 0
                  ? `${fileName} - ${fileSize}`
