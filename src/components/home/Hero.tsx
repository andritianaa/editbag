...
export const Hero = (props: HeroProps) => {
  return (
    <Layout className="flex flex-col items-center justify-center">
      <div className="flex h-[70vh] w-full flex-col items-start justify-center space-y-8 p-8">
        <div className="text-left text-3xl font-bold text-white sm:text-4xl lg:text-6xl">
          ...
          <p className="">for stunning video creations</p>
        </div>
      ...
      <div className="flex h-[70vh] w-full flex-col items-center space-y-8 p-8">
        <div className="rounded-lg border border-[#3f3f3f] bg-[#212121] p-8">
          <img
            src="/screenshot.png"
            alt=""
            className="max-w-5xl rounded-lg shadow-xl"
          />
        </div>
      </div>

      <div className="flex w-full max-w-6xl items-start justify-center gap-10 p-8">
        ...
        <div className="sticky top-[4rem] w-[50%]">
      ...
      <div className="flex w-full max-w-6xl flex-row-reverse items-start justify-center gap-10 p-8">
        <Card className="flex w-[50%] items-center justify-center border border-[#3f3f3f] bg-[#212121]">
          <img
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="150"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#c2a8ff]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#c2a8ff] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="200"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#ff99eb]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#ff99eb] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 36 36"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="250"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#ffbb80]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#ffbb80] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="300"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#ffe27a]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#ffe27a] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="350"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#69f28d]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#69f28d] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              ...
              data-aos-delay="400"
            >
              <div className="relative z-10 mb-10 flex size-14 items-center justify-center rounded-[14px] bg-[#8ecffb]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex size-14 rotate-[25deg] items-center justify-center rounded-[14px] bg-[#8ecffb] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                className="shadow-pricing relative z-10 mb-10 overflow-hidden rounded-xl border border-[#3f3f3f] bg-[#191919] px-8 py-10 sm:p-12 lg:px-6 lg:py-10 xl:p-14"
              >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                data-aos="zoom-in-down"
                className="shadow-pricing relative z-10 mb-10 overflow-hidden rounded-xl border-4 border-[#fbc466] bg-[#191919] px-8 py-10 sm:p-12 lg:px-6 lg:py-10 xl:p-14"
              >
