...
export const Features = (props: FeaturesProps) => {
  ...
  return (
    <section className="bg-[#020817] pb-8 pt-20 lg:pb-[70px] lg:pt-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
              ...
              <h2
                className="text-dark mb-3 text-3xl font-bold dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]"
                data-aos="fade-up"
              >
                Main Features Of Play
              </h2>
              <p className="text-dark-6 text-base" data-aos="fade-up">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div
              ...
              data-aos-delay="150"
            >
              <div className="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-[#fbc466]">
                <span className="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-[#fbc466] bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
              ...
              <a
                ...
                className="text-dark text-base font-medium hover:text-[#fbc466] dark:text-white dark:hover:text-[#fbc466]"
              >
                Learn More
              </a>
            </div>
