...
export const Hero = (props: HeroProps) => {
  ...
  return (
    <div
      id="home"
      className="relative overflow-hidden bg-transparent pt-[120px] md:pt-[130px] lg:pt-[160px]"
    >
      <div className="container">
        <div className="zoomEffect -mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                A place where you can donwload a ton 3D assets, After effect
                modules, sound effects, Photoshop presets and more
              </p>
              <Link
                href="/products"
              ...
              <div className="">
                <p className="mb-4 text-center text-base font-medium text-white">
                  Download for your favorite tools
                </p>
                <div
                ...
                >
                  <Image
                    src="/logo/afterEffect.png"
                    alt="afterEffect"
                    className="rounded-full object-cover transition-transform duration-100 hover:scale-125"
                    width={50}
                    height={50}
                  />
                  <Image
            ...
            >
              <div className="mt-16">
                ...
                <img
                  src="/screenshot.png"
                  alt="hero"
                  className="mx-auto max-w-full border-spacing-10 rounded-t-xl rounded-tr-xl border-[.5rem] border-b-0 border-[#fbc466] duration-100 hover:scale-105"
                />
              </div>
      ...
      <div className="absolute start-0 top-2/4 block -translate-x-10 -translate-y-3/4 scale-125 transform">
        <svg
      ...
      <div className="absolute end-0 top-2/4 block -translate-y-2/4 translate-x-10 scale-125 transform">
        <svg
